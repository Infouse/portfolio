...
const Main = () => {
  return (
    <div className='mainContainer'>
      ...
      작은 개선이라도 이루어 내어, 다음 작업에 반영할 수 있도록 노력하고 있습니다.<br/>
      이러한 피드백 과정을 통해 기술적 깊이와 유연함을 갖춘 개발자로 성장하여, <br/>
      어떤 프로젝트에서도 가치를 더하는 개발자가 되겠습니다.</p>
      <h2 className='projectListTitle'>Team project</h2>
      <ul className='projectList'>
        <li className='projectBox'>
          <div className='projectThumbnail'>
            <img src="" alt="" />
          </div>
          <h3 className=''>Daon 리뉴얼</h3>
          <p>기술스택 : Html/Sass/JavaScript</p>
          <p>소요 기간 : 약 2주</p>
          <p>담당한 페이지 : 객실안내, 이벤트, 이용후기</p>
          <p>담당한 기능 : Modal 팝업창 </p>
          <p>설명 : Front-end에 입문한 후 가장 초창기에 만든 웹페이지로 기존의 다온펜션 사이트를 리뉴얼 하였습니다.</p>
        </li>
        <li className='projectBox'>
          <div className='projectThumbnail'>
            <img src="" alt="" />
          </div>
          <h3 className=''>IEUM 모바일 웹 (책 소개 사이트)</h3>
          <p>기술스택 : React/Next.js, Zustand, Firestore, Nextauth</p>
          <p>소요 기간 : 약 10일</p>
          <p>담당한 페이지 : 로그인, 회원가입, 아이디찾기, 마이페이지</p>
          <p>담당한 기능 : Firestore DB 구축, Nextauth 활용한 로그인 및 회원가입, 코멘트(DB에 넣는작업)</p>
          <p>설명 : 경험이 없었던 서버 구축과 Nextauth를 활용하여 로그인 기능을 쉽게 만들기 위해 Next를 사용, 책 소개 모바일 홈페이지를 제작 하였습니다(390px). </p>
        </li>
      </ul>
